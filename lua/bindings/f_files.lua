...
F_FILES.setup = function()
	...
	local mappings = {
    {
      ...
      { "<leader>fn", "<cmd>Telescope file_browser path=%:p:help |select_buffer=true<cr>|", desc = "File Browser", nowait = true, remap = false },
      ...
      { "<leader>ff", "<cmd>Telescope find_files<cr>", desc = "Find File Fuzzy", nowait = true, remap = false },
